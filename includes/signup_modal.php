    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="signup-modal">Signup with PG Life</h5>
            ...
            <div class="modal-body">
                <form id="signup-form" class="form" role="form" method="post" action="api/signup_submit.php">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="text" class="form-control" name="college" placeholder="College Name" maxlength="30" required />
                    </div>
