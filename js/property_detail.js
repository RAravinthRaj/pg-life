window.addEventListener("load", function () {
  ...
  var is_interested_image = document.getElementsByClassName(
    "is-interested-image"
  )[0];
...
var toggle_interested_success = function (event) {
  ...
  if (response.success) {
    ...
    var interested_user_count = document.getElementsByClassName(
    ...
    alert("You have to login to our website");
