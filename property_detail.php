<?php
    ...
    $sql_1 = "SELECT * , p.id AS property_id , p.name AS property_name , c.name AS city_name
              FROM properties p INNER JOIN cities c 
              ON p.city_id = c.id  WHERE p.id = $property_id";
    ...
    $sql_3 = "SELECT a. * FROM amenities a INNER JOIN 
             properties_amenities pa ON a.id = pa.amenity_id 
    ...
    $interested_user_count = mysqli_num_rows($result_4);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="content-container col-md-8 page-container justify-content-around">
            <div class="row no-gutters justify-content-between">
                ...
                <div class="interested-container">
                    ...
                    $is_interested = false;
                    foreach($interested_users as $interested_user_property){
                        if($interested_user_property['property_id'] == $property['property_id']){
